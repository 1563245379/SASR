"""
Proximal Policy Optimization (PPO) for discrete actions and image observations (e.g. Super Mario Bros).
Categorical policy, shared CNN actor–critic, GAE-Lambda, clipped surrogate.
"""
...
class PPODiscrete:
    ...
    def learn(self, total_timesteps=1_000_000):
        ...
        pbar = tqdm(range(num_updates), desc="PPO-Mario Learning")
